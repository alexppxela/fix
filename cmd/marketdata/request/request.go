...
func init() {
	...
	MarketDataRequestCmd.Flags().BoolVar(&optionPrintNews, "news", true, "Print news")
...
func Execute(cmd *cobra.Command, args []string) error {
	...
	app := application.NewMarketDataRequest(optionPrintData, optionPrintNews)
	app.Logger = logger
